...
namespace LocalizationExtension
{
    ...
    public class LocalizationReferenceField : VisualElement
    {
        ...
        public LocalizationReferenceField(string name, string label, string[] classNames, EventCallback<ChangeEvent<string>> onChanged, EventCallback<FocusOutEvent> onFocusOut, int maxLength = -1)
        {
            // load some data.. 
            var i2LocalizationAsset = AssetDatabase.LoadAssetAtPath<I2.Loc.LanguageSourceAsset>("Assets/ResourcesStatic/Data/Resources/I2Languages.asset");
    ...
    public class LocalizationReferencePropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                var englishValue = i2LocalizationAsset.SourceData.GetTranslation(keyProperty.stringValue, "english"); 
                if (string.IsNullOrEmpty(englishValue))
                {
